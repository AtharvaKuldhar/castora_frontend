  ...
  useEffect(() => {
    const fetchElections = async () => {
      try {
        ...
        // Verify election status with blockchain
          ...
          <div>
            ...
            <div className="mt-4 space-x-3">
              <button
                onClick={() => setFilter('ongoing')}
                className={`px-4 py-2 rounded-lg transition ${
                  filter === 'ongoing' ? 'bg-blue-600 text-white' : 'bg-gray-200 hover:bg-gray-300'
                }`}
              >
                Ongoing
              </button>
              <button
                onClick={() => setFilter('past')}
                className={`px-4 py-2 rounded-lg transition ${
                  filter === 'past' ? 'bg-blue-600 text-white' : 'bg-gray-200 hover:bg-gray-300'
                }`}
              >
                Past
              </button>
        ...
        {loading ? (
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {elections.length > 0 ? (
              ...
              <p className="text-gray-500 col-span-full">No {filter} elections found.</p>
            )}
          </div>
        )}
      </div>
